...
%	Description:
%
%	K = SIMXRBFKERNCOMPUTE(SIMKERN, RBFKERN, T) computes cross kernel
...
%
%	K = SIMXRBFKERNCOMPUTE(SIMKERN, RBFKERN, T1, T2) computes cross
...
% 	simXrbfKernCompute.m SVN version 316
% 	last update 2009-03-04T19:25:25.000000Z
