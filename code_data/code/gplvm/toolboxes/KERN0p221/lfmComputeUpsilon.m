...
%	Description:
%
%	UPSILON = LFMCOMPUTEUPSILON(GAMMA, SIGMA2, TT1, TT2, MODE) computes
...
%	  TT1 - first time input (number of time points of x1 x number of
%	   time points of x2).
%	  TT2 - second time input (number of time points x number of time
%	   points of x2).
...
%
%	See also
%	LFMKERNPARAMINIT, LFMXLFMKERNCOMPUTE, LFMCOMPUTEH, W


%	Copyright (c) Mauricio Alvarez, 2008 David Luengo
% 	lfmComputeUpsilon.m SVN version 285
% 	last update 2009-03-04T20:53:54.000000Z
