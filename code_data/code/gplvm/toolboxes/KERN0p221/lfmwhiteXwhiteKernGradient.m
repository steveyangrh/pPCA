...
%	WHITE kernels.
%
%	[G1, G2] = LFMWHITEXWHITEKERNGRADIENT(LFMKERN, WHITEKERN, T1,
%	COVGRAD) computes the gradient of an objective function with respect
%	to cross kernel terms between LFM-WHITE and WHITE kernels for the
...
%
%	[G1, G2] = LFMWHITEXWHITEKERNGRADIENT(LFMKERN, WHITEKERN, T1, T2,
%	COVGRAD) computes the gradient of an objective function with respect
%	to cross kernel terms between LFM-WHITE and WHITE kernels for the
%	multiple output kernel.
%	 Returns:
...
% 	lfmwhiteXwhiteKernGradient.m SVN version 306
