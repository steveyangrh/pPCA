...
%	and t2.
%
%	K = SIMWHITEKERNCOMPUTE(KERN, T1, T2) computes the kernel parameters
%	for the SIM-White (Single Input Motif - White) kernel given inputs
...
% 	simwhiteKernCompute.m SVN version 198
