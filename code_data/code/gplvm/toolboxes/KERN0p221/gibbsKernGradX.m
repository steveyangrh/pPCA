...
%	Description:
%
%	G = GIBBSKERNGRADX(KERN, X1, X2) computes the gradident of the Mark
%	Gibbs's non-stationary kernel with respect to the input positions
...
% 	gibbsKernGradX.m CVS version 1.2
% 	gibbsKernGradX.m SVN version 1
